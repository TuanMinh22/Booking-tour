...
const TABLE_HEAD = [
  ...
  { id: 'numPerson', label: 'Số người', alignRight: false },
  { id: 'DateOfBooking', label: 'Ngày dự kiến', alignRight: false },
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                    const { BookingId, nameTour, numPerson, DateOfBooking, amount, Status } = row;
                    ...
                    return (
                      <TableRow hover key={BookingId} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="left">{nameTour}</TableCell>
                        ...
                        <TableCell align="right" key={BookingId}>
