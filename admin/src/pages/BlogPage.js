...
const TABLE_HEAD = [
  ...
  { id: 'des', label: 'Nội dung', alignRight: false },
  ...
  return (
    <>
      ...
      <Container>
        ...
        <Card>
          <UserListToolbar numSelected={selected.length} filterName={filterName} onFilterName={handleFilterByName} searchFor='Tìm kiếm theo Tiêu đề' />
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                    const { PostId, title, des, img } = row;
                    const selectedUser = selected.indexOf(title) !== -1;

                    return (
                      <TableRow hover key={PostId} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="right" key={PostId}>
                          <Link to={`/dashboard/hotel/${row.Post_ID}`}>
