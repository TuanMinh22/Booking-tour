...
const TABLE_HEAD = [
  { id: 'name', label: 'Người đánh giá', alignRight: false },
  { id: 'serviceRating', label: 'Số sao', alignRight: false },
  { id: 'comment', label: 'Bình luận', alignRight: false },
  { id: '' },
];
  ...
  return (
    <>
      ...
      <Container>
        ...
        <Card>
          <UserListToolbar numSelected={selected.length} filterName={filterName} onFilterName={handleFilterByName} searchFor='Tìm kiếm theo Tên người bình luận' />
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                    const { FeedbackId, firstName, lastName, serviceRating, Comments, Image } = row;
                    const selectedUser = selected.indexOf(firstName) !== -1;

                    return (
                      <TableRow hover key={FeedbackId} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="left">{serviceRating}</TableCell>

                        <TableCell align="left">{Comments}</TableCell>

                        <TableCell align="right" key={FeedbackId}>
                            ...
                            <div className="dialog-overlay" >
                              <div className="dialog-content" >
                                ...
                                <div className="dialog-buttons">
                                  ...
                                  <button className="dialog-button dialog-button-confirm" onClick={() => handleDeleteConfirm(index, row.Feedback_ID)}>Có</button>
                                </div>
                              </div>
                            </div>
                          )}
